...
.setDescription('Doğru Kullanım: s!istek-bildir Bence bunu bunu eklerseniz daha iyi olur'));
...
client.channels.get('797936818100240484').send(embed2); // Kanal ID 
